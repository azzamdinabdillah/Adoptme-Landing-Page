...
const HeroSection = () => {
    return (
      <section
        className="px-8 pb-14 md:px-20 md:py-20 lg:px-32 pt-14"
        style={{
          backgroundImage:
        ...
        <div className="lg:flex flex-row-reverse gap-10 items-center">
          <div className="pt-10">
            <img
              ...
              alt=""
              className="mx-auto md:w-[70%] lg:w-[100vw] lg:translate-x-10"
            />
          </div>

          <div className="mt-10 md:w-[100%] lg:w-[100%]">
            <h1 className="text-3xl md:text-4xl lg:text-[54px] lg:leading-relaxed font-medium md:w-[80%] lg:w-full">
              Lets Choose and{" "}
              <span className="ml-2">
                <img
                  src="./images/kaki.png"
                  alt=""
                  className="inline scale-90"
                />
              </span>{" "}
              Adopt your new Pet
            </h1>

            <p className="my-6 md:my-5 text-light-dark-color lg:text-[20xp] md:text-lg md:w-[80%] lg:w-[80%]">
            ...
            <div className="flex items-center gap-5 ">
              ...
              <button className="text-dark-color font-bold">
                Donate For Food
              </button>
            </div>
